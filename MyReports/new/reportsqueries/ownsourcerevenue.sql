...
join gfs_codes gfs on ga.gfs_code = gfs.code
    ...
    where ga.gl_account_type  = 'REVENUE'
      ...
      and geg.facility_id = 5593 and fs.code in ('80A','80B','80C','80D','80E')
...
--- Hizo fund code zinatakiwa kuwa za own source, finance watatoa nyingine nyingi za kutumia hapo
